...
const esOverrides: Record<string, string> = {
        ...
        'taskEdit.contextsLabel': 'Contextos (separados por coma)',
        'taskEdit.tagsLabel': 'Etiquetas (separadas por coma)',
        ...
        'projects.sortByName': 'Órden A–Z',
        'projects.sortByColor': 'Órden por color',
        ...
        'projects.deferredSection': 'Algún dia/Tal vez o En espera',
        ...
        'tutorial.boardText': 'Visualiza tu flujo de trabajo. Arrastra tareas entre estados (Siguiente, En espera, Commpletadas).',
        ...
        'review.startTime': 'Hora de inicio',
        ...
        'ai.missingKeyTitle': 'Require una clave de API',
        ...
        'agenda.focusHint': "Haz click en la estrella en cualquier tarea de abajo para añadirla a la lista de enfoque de hoy (3 máx).",
        ...
        'taskAge.weeks': 'semanas de angigüedad',
        ...
        'search.inProjectSuffix': 'En projecto',
